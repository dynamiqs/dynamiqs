    ...
    Examples:
        ...
        Array([[0.       +0.j, 0.       +0.j, 0.       +0.j, 0.       +0.j,
               ...
               [0.       +0.j, 0.       +0.j, 0.       +0.j, 1.       +0.j,
                0.       +0.j, 0.       +0.j],
               [0.       +0.j, 0.       +0.j, 0.       +0.j, 0.       +0.j,
                1.4142135+0.j, 0.       +0.j]], dtype=complex64)
    """  # noqa: E501
    if len(dims) == 1:
...
def displace(dim: int, alpha: ArrayLike) -> Array:
    ...
    Examples:
        >>> dq.displace(4, 0.5)
        Array([[ 0.8824947 +0.j, -0.44128302+0.j,  0.1556681 +0.j,
                -0.04732665+0.j],
               [ 0.44128302+0.j,  0.6623468 +0.j, -0.54209626+0.j,
                 0.269625  +0.j],
               [ 0.1556681 +0.j,  0.54209626+0.j,  0.44219884+0.j,
                -0.69739455+0.j],
               [ 0.04732665+0.j,  0.26962498+0.j,  0.69739455+0.j,
                 0.6623468 +0.j]], dtype=complex64)
...
def squeeze(dim: int, z: ArrayLike) -> Array:
    ...
    Examples:
        >>> dq.squeeze(4, 0.5)
        Array([[ 0.9381483 +0.j,  0.        +0.j,  0.34623358+0.j,
                 0.        +0.j],
               [ 0.        +0.j,  0.8182866 +0.j,  0.        +0.j,
                 0.5748103 +0.j],
               [-0.34623355+0.j,  0.        +0.j,  0.93814826+0.j,
                 0.        +0.j],
               [ 0.        +0.j, -0.5748104 +0.j,  0.        +0.j,
                 0.81828666+0.j]], dtype=complex64)
...
def quadrature(dim: int, phi: float) -> Array:
    ...
    Examples:
        ...
        Array([[0.        +0.j, 0.5       +0.j, 0.        +0.j],
               [0.5       +0.j, 0.        +0.j, 0.70710677+0.j],
               [0.        +0.j, 0.70710677+0.j, 0.        +0.j]], dtype=complex64)
        >>> dq.quadrature(3, jnp.pi / 2)
        Array([[ 0.0000000e+00+0.j        , -2.1855694e-08-0.5j       ,
                 0.0000000e+00+0.j        ],
               [-2.1855694e-08+0.5j       ,  0.0000000e+00+0.j        ,
                -3.0908620e-08-0.70710677j],
               [ 0.0000000e+00+0.j        , -3.0908620e-08+0.70710677j,
...
def momentum(dim: int) -> Array:
    ...
    Examples:
        ...
        Array([[0.+0.j        , 0.-0.5j       , 0.+0.j        ],
               [0.+0.5j       , 0.+0.j        , 0.-0.70710677j],
               [0.+0.j        , 0.+0.70710677j, 0.+0.j        ]], dtype=complex64)
    """
    a = destroy(dim)
    return 0.5j * (dag(a) - a)
...
def hadamard(n: int = 1) -> Array:
    ...
    Examples:
        ...
        >>> dq.hadamard(2)
        Array([[ 0.49999997+0.j,  0.49999997+0.j,  0.49999997+0.j,
                 0.49999997+0.j],
               [ 0.49999997+0.j, -0.49999997+0.j,  0.49999997+0.j,
                -0.49999997+0.j],
               [ 0.49999997+0.j,  0.49999997+0.j, -0.49999997+0.j,
                -0.49999997+0.j],
               [ 0.49999997+0.j, -0.49999997+0.j, -0.49999997+0.j,
                 0.49999997-0.j]], dtype=complex64)
    """
