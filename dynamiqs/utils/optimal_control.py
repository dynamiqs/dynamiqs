...
def snap_gate(phase: ArrayLike) -> Array:
    ...
    Examples:
        ...
        Array([[ 1.        +0.j        ,  0.        +0.j        ,
                 0.        +0.j        ],
               [ 0.        +0.j        ,  0.5403023 +0.84147096j,
                 0.        +0.j        ],
               [ 0.        +0.j        ,  0.        +0.j        ,
                -0.41614684+0.9092974j ]], dtype=complex64)
...
def cd_gate(dim: int, alpha: ArrayLike) -> Array:
    ...
    Examples:
        >>> dq.cd_gate(2, 0.1)
        Array([[ 0.99875027+0.j,  0.        +0.j, -0.04997917+0.j,
                 0.        +0.j],
               [ 0.        +0.j,  0.99875027+0.j,  0.        +0.j,
                 0.04997917+0.j],
               [ 0.04997917+0.j,  0.        +0.j,  0.9987502 +0.j,
                 0.        +0.j],
               [ 0.        +0.j, -0.04997917+0.j,  0.        +0.j,
                 0.9987502 +0.j]], dtype=complex64)
