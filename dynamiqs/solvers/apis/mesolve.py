...
from ..core.diffrax_solver import (
    mesolve_dopri5_solver_constructor,
    mesolve_dopri8_solver_constructor,
    mesolve_euler_solver_constructor,
    mesolve_kvaerno3_solver_constructor,
    mesolve_kvaerno5_solver_constructor,
    mesolve_tsit5_solver_constructor,
)
from ..core.expm_solver import mesolve_expm_solver_constructor
from ..core.rouchon_solver import mesolve_rouchon1_solver_constructor
...
def _mesolve(
    ...
    solver_constructors = {
        Euler: mesolve_euler_solver_constructor,
        Rouchon1: mesolve_rouchon1_solver_constructor,
        Dopri5: mesolve_dopri5_solver_constructor,
        Dopri8: mesolve_dopri8_solver_constructor,
        Tsit5: mesolve_tsit5_solver_constructor,
        Kvaerno3: mesolve_kvaerno3_solver_constructor,
        Kvaerno5: mesolve_kvaerno5_solver_constructor,
        Expm: mesolve_expm_solver_constructor,
    }
