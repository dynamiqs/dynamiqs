...
from ..bases import SESolveProblem
...
class CrossResonanceModulatedSESolveProblem(SESolveProblem):
    """Representation of a cross-resonance modulated sesolve problem.

    This simulates a closed two-qubit Schrödinger evolution inspired by a
    cross-resonance gate, with a constant interaction Hamiltonian and a modulated drive.

    Based-on:
        https://github.com/Nicolas-Lepage/dynamiqs/blob/feat/benchmark_MVP/tests/benchmark/bench_cross_resonance_modulated_sesolve.py
    """

    problem_name: ClassVar[str] = 'cross_resonance_modulated_sesolve'

    @override
    def build(self) -> tuple[dq.TimeQArray, dq.QArray, jax.Array]:
...
__all__ = ['CrossResonanceModulatedSESolveProblem']
